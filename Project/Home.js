...
export const MyPlugin = () => {
  return (
    <div id="webcrumbs"> 
                	<div  className="flex bg-gradient-to-t from-purple-300 via-purple-50 to-indigo-200 min-h-[600px] p-6 shadow-lg rounded-lg text-neutral-950 relative hover:scale-105 transition-transform duration-300"  style={{ boxShadow: "0px 10px 30px rgba(0, 0, 0, 0.1)" }}
    	>
    	  <div className="flex flex-col bg-white/40 backdrop-blur-md rounded-lg shadow-md p-4 w-[250px]">
    	    <div className="mb-8 flex items-center gap-2">
    	      ...
    	      />
    	      <h1 className="font-title text-xl font-bold text-neutral-800">Drive</h1>
    	    </div>
    	    <ul className="space-y-6">
    	      ...
    	      <li className="flex items-center gap-4 text-neutral-800 shadow-md p-2 rounded-md hover:bg-indigo-100 transition">
    	        <span className="material-symbols-outlined text-indigo-500">folder</span>
    	        My Drive
    	      </li>
    	      <li className="flex items-center gap-4 text-neutral-800 shadow-md p-2 rounded-md hover:bg-indigo-100 transition">
    	        <span className="material-symbols-outlined text-indigo-500">people</span>
    	        Shared
    	      </li>
    	    </ul>
    	  </div>
    	  <div className="flex-1 pl-8">
    	    <h1 className="text-4xl font-title font-bold text-center text-neutral-800 mb-6">Welcome to Drive</h1>
    	    <div className="flex-1 bg-white rounded-full p-2 shadow mb-6">
    	      <div className="flex gap-4 flex-row">
    	        <span className="material-symbols-outlined text-neutral-500 pl-4">search</span>
    	        <input
    	          type="text"
    	      ...
    	      <div className="grid grid-cols-3 gap-4">
    	        ...
    	        <div className="p-4 bg-white rounded-md shadow-md flex justify-between items-center text-neutral-800 transform transition-transform duration-300 hover:scale-105">
    	          ...
    	          <div>
    	            ...
    	            <p className="text-sm text-neutral-500">In Shared with CDAC</p>
    	          </div>
    	          <span className="material-symbols-outlined text-neutral-500">more_vert</span>
    	        </div>
    	      </div>
    	    ...
    	    <div className="mt-6 bg-white/40 backdrop-blur-md p-4 rounded-lg shadow-md">
    	      <h2 className="font-medium text-lg mb-4 text-neutral-800">Drive Space</h2>
    	      ...
    	      <p className="text-sm text-neutral-500 mt-2 text-right">70% used - 7GB of 10GB</p>
    	    </div>
    	    <button className="w-full px-6 py-3 mt-8 bg-white/40 backdrop-blur-md border-2 border-white/40 text-neutral-800 rounded-full hover:bg-indigo-500 hover:scale-105 hover:shadow-lg transition duration-300 text-lg font-bold">
    	      LogOut
    	    </button>
    	  </div>
    	</div> 
